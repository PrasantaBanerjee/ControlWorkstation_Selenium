...
public class Test_EquityMoneyMovement extends MoneyMovement {
	...
	public void validate_equityMoneyMovementPage() {
		result = Reports.extent.createTest("Equity Money Movement", "Validate Equity Money Movement page");
