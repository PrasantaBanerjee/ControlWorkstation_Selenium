...
public class Test_EquityRateNotification extends HistoryRateNotification {
	...
	public void validate_equityRateNotificationPage() {
		result = Reports.extent.createTest("Equity Rate Notification", "Validate Equity Rate Notification page");
