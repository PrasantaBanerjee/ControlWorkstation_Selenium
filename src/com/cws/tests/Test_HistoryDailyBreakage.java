...
import com.cws.page_objects.HistoryDailyBreakage;
import com.cws.utils.Reports;
import com.cws.utils.Screenshot;

public class Test_HistoryDailyBreakage extends HistoryDailyBreakage {
	...
	public void validate_histDailyBreakagePage() {
		result = Reports.extent.createTest("History Daily Breakage", "Validate History Daily Breakage page");
		histDailyBreakageTab().click();
		cf.sleepWait(1000);

		//Select date.
		Select date = new Select(getDriver().findElement(By.xpath("//select[@name='ctl00$ContentPlaceHolder1$ddlhistory']")));
		String dateVal = "2020/09/30";
