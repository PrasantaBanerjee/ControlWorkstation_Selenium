...
import com.cws.page_objects.MoneyMovement;
import com.cws.utils.Reports;
import com.cws.utils.Screenshot;

public class Test_HistoryMoneyMovement extends MoneyMovement {
	...
	public void validate_histMoneyMovementPage() {
		result = Reports.extent.createTest("History Money Movement", "Validate History Money Movement page");
		histMoneyMovementTab().click();
		cf.sleepWait(1000);
