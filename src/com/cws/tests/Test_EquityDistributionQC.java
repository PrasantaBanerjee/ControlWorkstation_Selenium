...
public class Test_EquityDistributionQC extends HistoryDistributionQC {
	...
	public void validate_equityDistQCPage() {
		result = Reports.extent.createTest("Equity Distribution QC", "Validate Equity Distribution QC page");
		histDistQCTab().click();
		cf.sleepWait(1000);
		...
		String portfolioVal = "Multimanager Lifestyle Conservative Port                                   ";
		portfolio.selectByValue(portfolioVal);
		result.log(Status.PASS, "Selected Portfolio as: "+portfolioVal);
		cf.sleepWait(2000);
		Screenshot.captureScreenshot(getDriver(), "Screenshot_");
