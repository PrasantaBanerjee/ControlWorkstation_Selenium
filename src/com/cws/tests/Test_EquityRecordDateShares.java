...
public class Test_EquityRecordDateShares extends RecordDateShares {
	...
	public void validate_eqRecordDateSharesPage() {
		result = Reports.extent.createTest("Equity Record Date Shares", "Validate Equity Record Date Shares page");
		recordDateSharesTab().click();
		cf.sleepWait(1500);
