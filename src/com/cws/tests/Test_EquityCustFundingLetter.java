...
import com.cws.page_objects.HistoryCustFundingLetter;
import com.cws.utils.Reports;
import com.cws.utils.Screenshot;

public class Test_EquityCustFundingLetter extends HistoryCustFundingLetter {
	...
	public void validate_equityCustFundingLetterPage() {
		result = Reports.extent.createTest("Equity Custody Funding Letter", "Validate Custody Funding Letter page");
		histCustFundLetterTab().click();
		cf.sleepWait(1500);
