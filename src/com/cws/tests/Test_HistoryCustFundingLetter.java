...
public class Test_HistoryCustFundingLetter extends HistoryCustFundingLetter {
	...
	public void validate_histCustFundingLetterPage() {
		result = Reports.extent.createTest("History Custody Funding Letter", "Validate History Custody Funding Letter page");
